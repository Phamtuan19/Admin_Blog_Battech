   ...
   return (
      <React.Fragment>
         <div className="px-4 pb-4">
            ...
            <Button fullWidth className="bg-sidebarActive h-10 rounded-lg" onClick={() => setOpen(true)}>
         ...
         <Modal open={open}>
            <div className="flex flex-col w-full h-full">
               <h3 className="text-[1.5rem] leading-[2rem] font-normal pt-10 px-8">Bạn có muốn đăng xuất hay không?</h3>
            </div>
            <div className="mt-10 px-8 mb-5 flex justify-end gap-3">
               <Button onClick={postLogout}>Đăng xuất</Button>
